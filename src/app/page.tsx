...
export default function Home() {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gray-50">
            <div className="container mx-auto p-4 relative">
                <div className="bg-white border-2 border-emerald-500 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col justify-center">
                        <h1 className="text-4xl text-emerald-700 font-bold mb-4">Welcome to the Blog</h1>
                        ...
                        <a href="/blog/posts" className="outline outline-1 outline-offset-2 border-emerald-800 text-emerald-500 hover:text-white py-2 px-4 rounded hover:bg-emerald-500 md:w-auto">
                          Read
                        </a>
                    </div>
            ...
            <div className="bg-emerald-800 hidden md:block absolute top-0 right-0 bottom-0 left-2/3 z-0"></div> 
        </main>
  );
}